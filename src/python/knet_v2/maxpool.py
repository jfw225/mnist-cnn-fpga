...
class Maxpool(Layer):
    ...
    def __init__(
        ...
        self.exponential = SignedExponential(
            int_width, dec_width, self.exp_num_terms)
        ...
        super().__init__(
            ...
            objects=[self.signed_max, self.signed_mult,
                     self.exponential, self.signed_div]
        )
    ...
    def forward(
        ...
        Z2 = maxpool_flat(x)
        print(x.shape, Z2.shape, weights_np.shape)
    ...
    def generate(self) -> V_Block:
        ...
        vsm = V_StateMachine(_StReset, _StWaitValid,
                             ...
                             _StIncMaxpool, _StWaitDotProduct,
                             _StWaitExponential, _StCheckSoftMaxReady,
                             _StWaitDiv, _StWriteData, _StClearDivReset)
