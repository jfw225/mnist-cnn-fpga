	Computer_System u0 (
		.fpga_ack_external_connection_export         (<connected-to-fpga_ack_external_connection_export>),         //         fpga_ack_external_connection.export
		.fpga_done_external_connection_export        (<connected-to-fpga_done_external_connection_export>),        //        fpga_done_external_connection.export
		.fpga_output_data_external_connection_export (<connected-to-fpga_output_data_external_connection_export>), // fpga_output_data_external_connection.export
		.hex3_hex0_export                            (<connected-to-hex3_hex0_export>),                            //                            hex3_hex0.export
		.hps_fclk_external_connection_export         (<connected-to-hps_fclk_external_connection_export>),         //         hps_fclk_external_connection.export
		.hps_input_addr_external_connection_export   (<connected-to-hps_input_addr_external_connection_export>),   //   hps_input_addr_external_connection.export
		.hps_input_data_external_connection_export   (<connected-to-hps_input_data_external_connection_export>),   //   hps_input_data_external_connection.export
		...
		.hps_reset_external_connection_export        (<connected-to-hps_reset_external_connection_export>),        //        hps_reset_external_connection.export
		.hps_valid_external_connection_export        (<connected-to-hps_valid_external_connection_export>),        //        hps_valid_external_connection.export
